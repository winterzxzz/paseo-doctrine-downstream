...
- **Open source:** This downstream distribution is AGPL-3.0 licensed. You can inspect it, modify it, and build on it.
...
This repository is a downstream of upstream Paseo. It keeps the product direction above and adds its own constraints:
...
### Current downstream state and candidate additions
