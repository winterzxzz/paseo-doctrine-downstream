...
| [research/upstream-v0.9.2-stable-integration-2026-09-25.md](research/upstream-v0.9.2-stable-integration-2026-09-25.md) | Stable v0.9.2 source boundary, adaptations per surface, post-merge review fixes, receipts, and gates not run                   |
