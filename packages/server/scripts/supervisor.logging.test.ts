...
import { DEFAULT_WORKER_TERMINATION_GRACE_MS } from "./supervisor.js";
  ...
  await writeFile(
    ...
    `
      ...
      runSupervisor({
        ...
        workerTerminationGraceMs: ${JSON.stringify(options.workerTerminationGraceMs)},
        logFile: {
...
describe("supervisor durable logging", () => {
  test("allows downstream worker and Beads cleanup to finish before force-kill", () => {
    expect(DEFAULT_WORKER_TERMINATION_GRACE_MS).toBeGreaterThan(20_000);
  });
