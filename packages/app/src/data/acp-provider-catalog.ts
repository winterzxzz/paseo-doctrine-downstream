...
const CATALOG_DATA = [
  ...
  },
  {
    ...
    command: ["npx", "-y", "cline@3.0.55", "--acp"],
  },
  {
    id: "codebuddy-code",
  ...
  },
  {
    ...
    command: ["npx", "-y", "deepagents-acp@0.1.25"],
  },
  {
    id: "devin",
    title: "Devin CLI",
  ...
  },
  {
    ...
    command: ["npx", "-y", "dimcode@0.3.13", "acp"],
  },
  {
    id: "dirac",
    title: "Dirac",
    ...
    command: ["npx", "-y", "dirac-cli@0.4.36", "--acp"],
  },
  {
    id: "factory-droid",
    title: "Factory Droid",
    ...
    command: ["npx", "-y", "droid@0.197.0", "exec", "--output-format", "acp-daemon"],
    env: {
  ...
  },
  {
    ...
    command: ["npx", "-y", "@google/gemini-cli@0.55.1", "--acp"],
  },
  {
    id: "gjc",
    title: "Gajae Code",
  ...
  },
  {
    ...
    command: ["npx", "-y", "@compass-ai/nova@1.1.35", "acp"],
  },
  {
    id: "poolside",
    title: "Poolside",
  ...
  },
  {
    ...
    command: ["npx", "-y", "@qwen-code/qwen-code@0.21.13", "--acp", "--experimental-skills"],
  },
  {
    id: "sigit",
    title: "siGit Code",
