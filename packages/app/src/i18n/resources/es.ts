...
export const es: TranslationResources = {
  ...
  agentPanel: {
    ...
    coordinationSignals: {
      ...
      kind: {
        continuity_attention: "Pregunta de atención",
        handoff_recommended: "Traspaso recomendado",
        detach_recommended: "Desvinculación recomendada",
      },
      reasonLabel: "Motivo",
      evidenceLabel: "Evidencia",
      evidenceDetailLabel: "Detalle de la evidencia",
      ...
      resolveAccessibilityLabel: "Marcar la señal como {{resolution}}",
      resolvingLabel: "Resolviendo…",
      resolveErrorLabel: "No se pudo resolver la señal",
    },
  },
  sessions: {
    title: "Historial",
  ...
  settings: {
    ...
    providers: {
      ...
      statuses: {
        ...
        configuredUnqualified: "Configurado · calificación pendiente",
        connectionUnverified: "Configurado · sin verificar",
        connectionQualified: "Conexión verificada",
        connectionQualificationStale: "Verificación obsoleta",
      },
      models: {
        one: "1 modelo",
        many: "{{count}} modelos",
      ...
      connection: {
        button: "Conexión",
        add: "Añadir",
        createTitle: "Añadir proveedor Codex personalizado",
        title: "Configurar la conexión de {{name}}",
        openAICompatible: "Codex personalizado",
        openAICompatibleHint: "Usa Codex con tu URL de Responses y clave API",
        providerId: "ID del proveedor",
        invalidProviderId: "Usa minúsculas, números y guiones, empezando por una letra",
        providerLabel: "Nombre",
        baseUrl: "URL base",
        invalidBaseUrl: "Introduce una URL HTTPS absoluta sin credenciales, consulta ni fragmento",
        apiKey: "Clave API",
        apiKeyPlaceholder: "Déjalo vacío para conservar la clave configurada",
        credentialConfigured: "Hay una clave API privada configurada",
        credentialMissing: "Introduce una clave API para configurar este proveedor",
        privateStorage: "La clave se guarda solo en este host y nunca se devuelve a la aplicación",
        hostDisconnected: "El host se desconectó antes de guardar la configuración",
        saveFailed: "No se pudo guardar la conexión del proveedor",
        test: "Probar conexión",
        testing: "Probando...",
        testQualified: "Conexión verificada para {{model}} en {{latency}} ms",
        testFailed: "Falló la prueba de conexión",
        save: "Guardar",
        saving: "Guardando...",
        deleteCredential: "Eliminar clave de API",
        deletingCredential: "Eliminando clave...",
        deleteCredentialConfirmTitle: "¿Eliminar la clave de API?",
        deleteCredentialConfirmMessage:
          "Esto elimina la credencial privada {{credentialRef}} de este host. Todos los proveedores que compartan esta referencia dejarán de funcionar hasta que se guarde una nueva clave.",
        deleteCredentialConfirm: "Eliminar clave",
        deleteCredentialFailed: "No se pudo eliminar la clave de API",
      },
      diagnostic: {
        title: "Diagnóstico",
        button: "Diagnóstico",
