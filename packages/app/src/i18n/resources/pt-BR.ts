...
export const ptBR: TranslationResources = {
  ...
  agentPanel: {
    ...
    coordinationSignals: {
      ...
      kind: {
        continuity_attention: "Pergunta de atenção",
        handoff_recommended: "Transferência recomendada",
        detach_recommended: "Desvinculação recomendada",
      },
      reasonLabel: "Motivo",
      evidenceLabel: "Evidência",
      evidenceDetailLabel: "Detalhe da evidência",
      ...
      resolveAccessibilityLabel: "Marcar o sinal como {{resolution}}",
      resolvingLabel: "Resolvendo…",
      resolveErrorLabel: "Falha ao resolver o sinal",
    },
  },
  sessions: {
  ...
  settings: {
    ...
    providers: {
      ...
      connection: {
        ...
        providerLabel: "Nome",
        baseUrl: "URL base",
        invalidBaseUrl: "Informe uma URL HTTPS absoluta sem credenciais, consulta ou fragmento",
        apiKey: "Chave de API",
        apiKeyPlaceholder: "Deixe em branco para manter a chave configurada",
        credentialConfigured: "Uma chave de API privada está configurada",
        credentialMissing: "Informe uma chave de API para configurar este provedor",
