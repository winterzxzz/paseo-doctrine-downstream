...
export const ja: TranslationResources = {
  ...
  agentPanel: {
    ...
    coordinationSignals: {
      ...
      kind: {
        continuity_attention: "注意喚起の質問",
        handoff_recommended: "引き継ぎ推奨",
        detach_recommended: "切り離し推奨",
      },
      reasonLabel: "理由",
      evidenceLabel: "根拠",
      evidenceDetailLabel: "根拠の詳細",
      observationLabel: "観測内容",
      questionLabel: "質問",
      ...
      resolveAccessibilityLabel: "シグナルを{{resolution}}としてマークする",
      resolvingLabel: "解決中…",
      resolveErrorLabel: "シグナルの解決に失敗しました",
    },
  },
  sessions: {
    title: "履歴",
  ...
  settings: {
    ...
    providers: {
      ...
      statuses: {
        ...
        connectionUnverified: "設定済み · 未検証",
        connectionQualified: "接続を検証済み",
        connectionQualificationStale: "検証が古くなっています",
      },
      models: {
        one: "1つのモデル",
        many: "{{count}}つのモデル",
      ...
      connection: {
        button: "接続",
        add: "追加",
        createTitle: "カスタム Codex プロバイダーを追加",
        title: "{{name}} の接続を設定",
        openAICompatible: "カスタム Codex",
        openAICompatibleHint: "独自の Responses URL と API キーで Codex を使用します",
        providerId: "プロバイダー ID",
        invalidProviderId: "英小文字、数字、ハイフンを使用し、英字で始めてください",
        providerLabel: "名前",
        baseUrl: "ベース URL",
        invalidBaseUrl: "認証情報、クエリ、フラグメントを含まない絶対 HTTPS URL を入力してください",
        apiKey: "API キー",
        apiKeyPlaceholder: "設定済みのキーを保持する場合は空欄にします",
        credentialConfigured: "非公開 API キーが設定されています",
        credentialMissing: "このプロバイダーを設定するには API キーを入力してください",
        privateStorage: "キーはこのホストだけに保存され、アプリには返されません",
        hostDisconnected: "設定を保存する前にホストが切断されました",
        saveFailed: "プロバイダー接続を保存できません",
        test: "接続をテスト",
        testing: "テスト中...",
        testQualified: "{{model}} の接続を {{latency}} ms で検証しました",
