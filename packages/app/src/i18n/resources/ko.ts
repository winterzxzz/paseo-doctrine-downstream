...
export const ko: TranslationResources = {
  ...
  agentPanel: {
    ...
    coordinationSignals: {
      ...
      kind: {
        continuity_attention: "주의 질문",
        handoff_recommended: "인계 권장",
        detach_recommended: "분리 권장",
      },
      reasonLabel: "사유",
      evidenceLabel: "근거",
      evidenceDetailLabel: "근거 상세",
      observationLabel: "관찰 내용",
      questionLabel: "질문",
      ...
      resolveAccessibilityLabel: "신호를 {{resolution}}(으)로 표시",
      resolvingLabel: "처리 중…",
      resolveErrorLabel: "신호 처리에 실패했습니다",
    },
  },
  sessions: {
    title: "기록",
    ...
    providers: {
      ...
      tools: {
        ...
        master: {
          ...
          accessibilityLabel: "{{name}}에서 Paseo 도구 활성화",
        },
        enableAll: "모두 활성화",
        disableAll: "모두 비활성화",
        globalOverride: {
          title: "Paseo 도구가 비활성화됨",
          description: "전역 Paseo 도구 삽입 설정이 저장된 프로바이더 및 도구 선택보다 우선합니다",
        },
        browserUnavailable: {
          title: "브라우저 도구를 사용할 수 없음",
          description:
            "이 도구를 사용하려면 호스트 설정에서 브라우저 도구를 켜세요. 저장된 선택은 변경되지 않습니다",
        },
      ...
      statuses: {
        ...
        configuredUnqualified: "구성됨 · 검증 대기 중",
        connectionUnverified: "구성됨 · 확인되지 않음",
        connectionQualified: "연결 확인됨",
        connectionQualificationStale: "확인이 만료됨",
      },
      models: {
        one: "모델 1개",
        many: "모델 {{count}}개",
      ...
      connection: {
        button: "연결",
        add: "추가",
        createTitle: "사용자 지정 Codex 프로바이더 추가",
        title: "{{name}} 연결 구성",
        openAICompatible: "사용자 지정 Codex",
        openAICompatibleHint: "자체 Responses 기본 URL 및 API 키로 Codex 사용",
        providerId: "프로바이더 ID",
        invalidProviderId: "문자로 시작하는 소문자, 숫자 및 하이픈을 사용하세요",
        providerLabel: "이름",
        baseUrl: "기본 URL",
        invalidBaseUrl: "자격 증명, 쿼리 또는 프래그먼트가 없는 절대 HTTPS URL을 입력하세요",
        apiKey: "API 키",
        apiKeyPlaceholder: "구성된 키를 유지하려면 비워 두세요",
        credentialConfigured: "비공개 API 키가 구성되어 있습니다",
        credentialMissing: "이 프로바이더를 구성하려면 API 키를 입력하세요",
        privateStorage: "키는 이 호스트에만 저장되며 앱으로 반환되지 않습니다",
        hostDisconnected: "구성이 저장되기 전에 호스트 연결이 끊어졌습니다",
        saveFailed: "프로바이더 연결을 저장할 수 없습니다",
        test: "연결 테스트",
        testing: "테스트 중...",
        testQualified: "{{model}} 연결 확인됨 ({{latency}}ms)",
        testFailed: "연결 테스트 실패",
        save: "저장",
        saving: "저장 중...",
        deleteCredential: "API 키 삭제",
        deletingCredential: "키 삭제 중...",
        deleteCredentialConfirmTitle: "API 키를 삭제할까요?",
        deleteCredentialConfirmMessage:
          "이 호스트에서 비공개 자격 증명 {{credentialRef}}을(를) 삭제합니다. 이 자격 증명 참조를 공유하는 모든 프로바이더는 새 키가 저장될 때까지 작동하지 않습니다.",
        deleteCredentialConfirm: "키 삭제",
        deleteCredentialFailed: "API 키를 삭제할 수 없습니다",
      },
      diagnostic: {
        title: "진단",
        button: "진단",
