...
export const zhCN: TranslationResources = {
  ...
  agentPanel: {
    ...
    coordinationSignals: {
      ...
      kind: {
        continuity_attention: "关注问题",
        handoff_recommended: "建议交接",
        detach_recommended: "建议分离",
      },
      reasonLabel: "原因",
      evidenceLabel: "证据",
      evidenceDetailLabel: "证据详情",
      observationLabel: "观察结果",
      questionLabel: "问题",
      ...
      resolveAccessibilityLabel: "将信号标记为{{resolution}}",
      resolvingLabel: "处理中…",
      resolveErrorLabel: "信号处理失败",
    },
  },
  sessions: {
    title: "历史",
  ...
  settings: {
    ...
    providers: {
      ...
      statuses: {
        ...
        connectionUnverified: "已配置 · 未验证",
        connectionQualified: "连接已验证",
        connectionQualificationStale: "验证已过期",
      },
      models: {
        one: "1 个 Model",
        many: "{{count}} 个 Model",
      ...
      connection: {
        button: "连接",
        add: "添加",
        createTitle: "添加自定义 Codex 提供商",
        title: "配置 {{name}} 连接",
        openAICompatible: "自定义 Codex",
        openAICompatibleHint: "使用你自己的 Responses URL 和 API 密钥运行 Codex",
        providerId: "提供商 ID",
        invalidProviderId: "使用小写字母、数字和连字符，并以字母开头",
        providerLabel: "名称",
        baseUrl: "基础 URL",
        invalidBaseUrl: "请输入不含凭据、查询或片段的绝对 HTTPS URL",
        apiKey: "API 密钥",
        apiKeyPlaceholder: "留空以保留已配置的密钥",
        credentialConfigured: "已配置私有 API 密钥",
        credentialMissing: "请输入 API 密钥以配置此提供商",
        privateStorage: "密钥仅存储在此主机上，绝不会返回给应用",
        hostDisconnected: "保存配置前主机已断开连接",
        saveFailed: "无法保存提供商连接",
        test: "测试连接",
        testing: "测试中...",
        testQualified: "已在 {{latency}} 毫秒内验证 {{model}} 的连接",
        testFailed: "连接测试失败",
        save: "保存",
        saving: "保存中...",
