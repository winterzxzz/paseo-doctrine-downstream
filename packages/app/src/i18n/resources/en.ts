export const en = {
  ...
  agentPanel: {
    ...
    coordinationSignals: {
      ...
      kind: {
        continuity_attention: "Attention question",
        handoff_recommended: "Handoff recommended",
        detach_recommended: "Detach recommended",
      },
      reasonLabel: "Reason",
      evidenceLabel: "Evidence",
      evidenceDetailLabel: "Evidence detail",
      ...
      resolveAccessibilityLabel: "Mark signal as {{resolution}}",
      resolvingLabel: "Resolving…",
      resolveErrorLabel: "Failed to resolve signal",
    },
  },
  sessions: {
    title: "History",
  ...
  settings: {
    ...
    providers: {
      ...
      statuses: {
        ...
        connectionUnverified: "Configured · unverified",
        connectionQualified: "Connection verified",
        connectionQualificationStale: "Verification stale",
      },
      models: {
        one: "1 model",
        many: "{{count}} models",
      ...
      connection: {
        button: "Connection",
        add: "Add",
        createTitle: "Add custom Codex provider",
        title: "Configure {{name}} connection",
        openAICompatible: "Custom Codex",
        openAICompatibleHint: "Use Codex with your own Responses base URL and API key",
        providerId: "Provider ID",
        invalidProviderId: "Use lowercase letters, numbers, and hyphens, starting with a letter",
        providerLabel: "Name",
        baseUrl: "Base URL",
        invalidBaseUrl: "Enter an absolute HTTPS URL without credentials, query, or fragment",
        apiKey: "API key",
        apiKeyPlaceholder: "Leave blank to keep the configured key",
        credentialConfigured: "A private API key is configured",
        credentialMissing: "Enter an API key to configure this provider",
        privateStorage: "The key is stored only on this host and is never returned to the app",
        hostDisconnected: "The host disconnected before the configuration was saved",
        saveFailed: "Unable to save provider connection",
        test: "Test connection",
        testing: "Testing...",
        testQualified: "Connection verified for {{model}} in {{latency}} ms",
