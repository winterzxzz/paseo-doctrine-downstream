...
export const ru: TranslationResources = {
  ...
  agentPanel: {
    ...
    coordinationSignals: {
      ...
      kind: {
        continuity_attention: "Вопрос о внимании",
        handoff_recommended: "Рекомендована передача",
        detach_recommended: "Рекомендовано отсоединение",
      },
      reasonLabel: "Причина",
      evidenceLabel: "Свидетельства",
      evidenceDetailLabel: "Детали свидетельств",
      ...
      resolveAccessibilityLabel: "Отметить сигнал как {{resolution}}",
      resolvingLabel: "Обработка…",
      resolveErrorLabel: "Не удалось обработать сигнал",
    },
  },
  sessions: {
    title: "История",
  ...
  workspaceSetup: {
    ...
    errors: {
      ...
      workspaceProtocolRequired:
        "Проверьте и исправьте Workspace Protocol в настройках проекта перед созданием агента с ролью.",
      workspaceProtocolUnsupported:
        "Обновите этот хост Paseo перед созданием агента с ролью. Требуемая возможность Workspace Protocol указана в настройках проекта.",
      workspaceProtocolInspectionFailed:
        "Paseo не смог проверить Workspace Protocol. Проверьте его в настройках проекта и повторите попытку.",
    },
  },
  onboarding: {
  ...
  settings: {
    ...
    providers: {
      ...
      remove: {
        ...
        confirmMessage:
          "Запись провайдера будет удалена из config.json. Закрытый credential сохранится, пока вы явно не удалите API key в разделе Connection.",
        confirm: "Удалить",
      ...
      statuses: {
        ...
        connectionUnverified: "Настроено · не проверено",
        connectionQualified: "Подключение проверено",
        connectionQualificationStale: "Проверка устарела",
      },
      models: {
        one: "1 модель",
        many: "{{count}} моделей",
      ...
      connection: {
        button: "Подключение",
        add: "Добавить",
        createTitle: "Добавить пользовательский Codex",
        title: "Настроить подключение {{name}}",
        openAICompatible: "Пользовательский Codex",
        openAICompatibleHint: "Используйте Codex со своим Responses URL и ключом API",
        providerId: "ID провайдера",
        invalidProviderId: "Используйте строчные буквы, цифры и дефисы, начиная с буквы",
        providerLabel: "Имя",
        baseUrl: "Базовый URL",
        invalidBaseUrl: "Введите абсолютный HTTPS URL без учетных данных, запроса и фрагмента",
        apiKey: "Ключ API",
        apiKeyPlaceholder: "Оставьте пустым, чтобы сохранить настроенный ключ",
        credentialConfigured: "Закрытый ключ API настроен",
        credentialMissing: "Введите ключ API для настройки провайдера",
        privateStorage: "Ключ хранится только на этом хосте и никогда не возвращается приложению",
        hostDisconnected: "Хост отключился до сохранения конфигурации",
        saveFailed: "Не удалось сохранить подключение провайдера",
        test: "Проверить подключение",
        testing: "Проверка...",
        testQualified: "Подключение {{model}} проверено за {{latency}} мс",
