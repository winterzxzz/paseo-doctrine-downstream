...
export const ar: TranslationResources = {
  ...
  agentPanel: {
    ...
    coordinationSignals: {
      ...
      kind: {
        continuity_attention: "سؤال انتباه",
        handoff_recommended: "يُوصى بالتسليم",
        detach_recommended: "يُوصى بالفصل",
      },
      reasonLabel: "السبب",
      evidenceLabel: "الأدلة",
      evidenceDetailLabel: "تفاصيل الأدلة",
      ...
      resolveAccessibilityLabel: "وسم الإشارة بـ {{resolution}}",
      resolvingLabel: "جارٍ الحل…",
      resolveErrorLabel: "فشل حل الإشارة",
    },
  },
  sessions: {
    title: "السجل",
  ...
  settings: {
    ...
    providers: {
      ...
      connection: {
        ...
        invalidBaseUrl: "أدخل عنوان HTTPS مطلقا من دون بيانات اعتماد أو استعلام أو جزء",
        apiKey: "مفتاح API",
        apiKeyPlaceholder: "اتركه فارغا للاحتفاظ بالمفتاح المضبوط",
        credentialConfigured: "تم ضبط مفتاح API خاص",
        credentialMissing: "أدخل مفتاح API لإعداد هذا المزود",
