...
export const fr: TranslationResources = {
  ...
  agentControls: {
    role: {
      fallback: "Rôle",
      select: "Sélectionner le rôle Paseo",
      title: "Rôle Paseo",
    },
    provider: {
  ...
  agentPanel: {
    ...
    coordinationSignals: {
      ...
      kind: {
        continuity_attention: "Question d'attention",
        handoff_recommended: "Transfert recommandé",
        detach_recommended: "Détachement recommandé",
      },
      reasonLabel: "Motif",
      evidenceLabel: "Preuves",
      evidenceDetailLabel: "Détail des preuves",
      ...
      resolveAccessibilityLabel: "Marquer le signal comme {{resolution}}",
      resolvingLabel: "Résolution en cours…",
      resolveErrorLabel: "Échec de la résolution du signal",
    },
  },
  sessions: {
    title: "Historique",
  ...
  settings: {
    ...
    providers: {
      ...
      connection: {
        ...
        providerLabel: "Nom",
        baseUrl: "URL de base",
        invalidBaseUrl: "Saisissez une URL HTTPS absolue sans identifiants, requête ni fragment",
        apiKey: "Clé API",
        apiKeyPlaceholder: "Laisser vide pour conserver la clé configurée",
        credentialConfigured: "Une clé API privée est configurée",
        credentialMissing: "Saisissez une clé API pour configurer ce fournisseur",
        privateStorage:
